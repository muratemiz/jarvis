...
class JarvisUI:
    ...
    def _build_social_bar(self):
        ...
        name_lbl.bind("<Button-1>", _open("https://www.linkedin.com/in/temizmurat/"))

        self._icon_ln = _load_icon("linkedin-logo.png")
        self._icon_gh = _load_icon("github-logo.png")

        if self._icon_ln:
            ln_lbl = tk.Label(bar, image=self._icon_ln, bg=C_BG, cursor="hand2")
            ln_lbl.pack(side="left", padx=4)
            ln_lbl.bind("<Button-1>", _open("https://www.linkedin.com/in/temizmurat/"))

        if self._icon_gh:
            gh_lbl = tk.Label(bar, image=self._icon_gh, bg=C_BG, cursor="hand2")
            gh_lbl.pack(side="left", padx=4)
            gh_lbl.bind("<Button-1>", _open("https://github.com/muratemiz"))
